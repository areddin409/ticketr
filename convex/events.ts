...
export const joinWaitingList = mutation({
  ...
  handler: async (ctx, { eventId, userId }) => {
    ...
    //active means any status expect EXPIRED
    ...
    if (existingEntry) {
      throw new Error("You're already in the waiting list for this event.");
    }
    ...
    if (available) {
      ...
      //if no tickets available, add user to waiting list
